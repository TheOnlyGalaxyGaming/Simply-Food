...
import net.mcreator.simplyfood.item.CherriesItem;
...
public class CherryBushBlock extends SimplyfoodModElements.ModElement {
	@ObjectHolder("simplyfood:cherry_bush")
	public static final Block block = null;
	public CherryBushBlock(SimplyfoodModElements instance) {
		super(instance, 14);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("simplyfood:cherry_bush"), configuredFeature);
		}
	}
	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		boolean biomeCriteria = false;
		if (new ResourceLocation("simplyfood:cherry_biome").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
