...
import net.mcreator.simplyfood.gui.SimplyFoodGUIGuiWindow;
import net.mcreator.simplyfood.gui.SimplyFoodGUIGui;
...
public class SimplyFoodsItem extends SimplyfoodModElements.ModElement {
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof SimplyFoodGUIGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Simply Food");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new SimplyFoodGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
